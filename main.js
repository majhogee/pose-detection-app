...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{keypoints: _List_Nil, submitted: false, url: ''},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$Received = function (a) {
	return {$: 'Received', a: a};
};
var $author$project$Main$receiveStuff = _Platform_incomingPort(
	'receiveStuff',
...
var $author$project$Main$subscriptions = function (model) {
	return $author$project$Main$receiveStuff($author$project$Main$Received);
};
	...
	return (!model.submitted) ? A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$UrlSubmitted)
					]),
				_List_fromArray(
					[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('posenetimg'),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'value', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Keypoint":{"args":[],"type":"{ score : Basics.Float, part : String.String, position : Main.Position }"},"Main.Position":{"args":[],"type":"{ x : Basics.Float, y : Basics.Float }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UrlSubmitted":[],"Change":["String.String"],"SendData":[],"Received":["List.List Main.Keypoint"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));